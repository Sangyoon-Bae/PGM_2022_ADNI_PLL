...
if __name__ == '__main__':
    ...
    ### rmse case
    evaluator = Evaluator('abcd-struct-ad') #ogbg-molipo to abcd-struct,
    evaluator = Evaluator('abcd-struct-count') #ogbg-molipo to abcd-struct,
    evaluator = Evaluator('abcd-struct-fa') #ogbg-molipo to abcd-struct,
    evaluator = Evaluator('abcd-struct-md') #ogbg-molipo to abcd-struct,
    evaluator = Evaluator('abcd-struct-rd') #ogbg-molipo to abcd-struct,
