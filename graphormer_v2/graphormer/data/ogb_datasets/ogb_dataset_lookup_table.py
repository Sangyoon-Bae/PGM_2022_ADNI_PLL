...
from ..ogb_modified.lsc.pcqm4mv2_pyg import PygPCQM4Mv2Dataset
...
class OGBDatasetLookupTable:
    ...
    def GetOGBDataset(dataset_name: str, seed: int) -> Optional[Dataset]:
        ...
        valid_idx = None
        test_idx = None
        if dataset_name == "adni-struct-count":
        ...
        elif dataset_name == "abcd-struct-ad":
            folder_name = dataset_name.replace("-", "_")
            os.system(f"mkdir -p dataset/{folder_name}/")
            os.system(f"touch dataset/{folder_name}/RELEASE_v1.txt")
            inner_dataset = MyPygGraphPropPredDataset(dataset_name)
        ...
        elif dataset_name == "abcd-struct-count":
            folder_name = dataset_name.replace("-", "_")
            os.system(f"mkdir -p dataset/{folder_name}/")
            os.system(f"touch dataset/{folder_name}/RELEASE_v1.txt")
            inner_dataset = MyPygGraphPropPredDataset(dataset_name)
        ...
        elif dataset_name == "abcd-struct-rd":
            folder_name = dataset_name.replace("-", "_")
            os.system(f"mkdir -p dataset/{folder_name}/")
            os.system(f"touch dataset/{folder_name}/RELEASE_v1.txt")
            inner_dataset = MyPygGraphPropPredDataset(dataset_name)
        ...
        elif dataset_name == "abcd-struct-md":
            folder_name = dataset_name.replace("-", "_")
            os.system(f"mkdir -p dataset/{folder_name}/")
            os.system(f"touch dataset/{folder_name}/RELEASE_v1.txt")
            inner_dataset = MyPygGraphPropPredDataset(dataset_name)
        ...
        elif dataset_name == "abcd-struct-fa":
            folder_name = dataset_name.replace("-", "_")
            os.system(f"mkdir -p dataset/{folder_name}/")
            os.system(f"touch dataset/{folder_name}/RELEASE_v1.txt")
            inner_dataset = MyPygGraphPropPredDataset(dataset_name)
